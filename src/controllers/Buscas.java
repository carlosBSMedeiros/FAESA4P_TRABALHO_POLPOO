...
//		
	...
	private static boolean verificaEsquerda(Tabela tabela, FilaPessoa result, int meio) {
		...
		if (tabela.getVetor()[esq] != null
				&& tabela.getVetor()[meio].getCpf().compareTo(tabela.getVetor()[esq].getCpf()) == 0) {
	...
	private static boolean verificaDireita(Tabela tabela, FilaPessoa result, int meio) {
		...
		if (tabela.getVetor()[dir] != null
				&& tabela.getVetor()[meio].getCpf().compareTo(tabela.getVetor()[dir].getCpf()) == 0) {
